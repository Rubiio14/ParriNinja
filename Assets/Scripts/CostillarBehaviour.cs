...
public class CostillarBehaviour : MonoBehaviour, SlizableItem
{
    ...
    [SerializeField]
    GameObject carneEntera, carneParte1, carneParte2, carneParte3;
    ...
    void Update()
    {
        ...
        carneParte3.transform.Rotate(m_RotacionPiezas);
        ...
        if (m_DespawnTimer >= 1.5f)
        {
            if (m_Smoke == false)
            {
                ...
                VFX_Smoke.instance.Smoke(smoke[2], carneParte3);
                m_Smoke = true;
            }
            carneParte1.SetActive(false);
            carneParte2.SetActive(false);
            carneParte3.SetActive(false);
        }
